    ...
    semanticTokens: {
      colors: {
        ...
        blue: {
          ...
          fg: { value: '#60a5fa' },
          muted: { value: 'rgba(59, 130, 246, 0.3)' },
        ...
        green: {
          ...
          contrast: { value: 'white' },
          fg: { value: '#34d399' },
          muted: { value: 'rgba(16, 185, 129, 0.3)' },
        ...
        red: {
          ...
          contrast: { value: 'white' },
          fg: { value: '#f87171' },
          muted: { value: 'rgba(239, 68, 68, 0.3)' },
        ...
        orange: {
          ...
          contrast: { value: 'white' },
          fg: { value: '#fb923c' },
          muted: { value: 'rgba(249, 115, 22, 0.3)' },
          subtle: { value: 'rgba(249, 115, 22, 0.15)' },
        ...
        gray: {
          ...
          muted: { value: 'rgba(107, 114, 128, 0.3)' },
          subtle: { value: 'rgba(107, 114, 128, 0.15)' },
